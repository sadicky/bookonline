                            ...
                            <div class="slider-wrap w-100 w-max-550px p-3 p-sm-5 m-auto">
                                <div class="slider-init">
                                    <div class="slider-item">
                                        <div class="nk-featre nk-feture-center">
                                            <div class="nk-featue-img">
                                                <img width="1900px" src="assets/images/abcd.jpg" srcset="assets/images/abcd.jpg 2x" alt="logo">
                                            </div>
                                            <!-- <h3 class="mt-50"> BookOnline System v1.0</h3> -->
                                        </div>
                                    </div><!-- .slider-item -->
                                </div><!-- .slider-init -->
                            </div><!-- .slider-wrap -->
